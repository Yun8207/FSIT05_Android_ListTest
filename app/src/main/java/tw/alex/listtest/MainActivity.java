...
public class MainActivity extends AppCompatActivity {
    ...
    String[] from = {"title","content","img"};
    int[] to  = {R.id.item_title,R.id.item_content,R.id.item_img};

    private int[] imgs = {R.drawable.img0, R.drawable.img1, R.drawable.img2, R.drawable.img3};
    @Override
    ...
    public void addItem(View view) {
        ...
        simpleAdapter.notifyDataSetChanged();// reset adapter
